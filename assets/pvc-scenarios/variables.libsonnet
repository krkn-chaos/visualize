{
  ...
  getAllVariables()::
    local scenario_type = 'pvc_scenarios';
    ...
    [
      ...
      self.queryVariable('storage_class', 'storage_class', '{"find": "terms", "field": "scenarios.parameters.storage_class.keyword", "query": "cloud_infrastructure.keyword: $platform AND cloud_type.keyword: $cloud_type AND scenarios.scenario_type.keyword: ' + scenario_type + '"}', '${Datasource}', true, true),
