{
  ...
  getAllVariables()::
    local scenario_type = 'service_hijacking_scenarios';
    ...
    [
      ...
      self.queryVariable('target_service', 'target_service', '{"find": "terms", "field": "scenarios.parameters.target_service.keyword", "query": "cloud_infrastructure.keyword: $platform AND cloud_type.keyword: $cloud_type AND scenarios.scenario_type.keyword: ' + scenario_type + '"}', '${Datasource}', true, true),
