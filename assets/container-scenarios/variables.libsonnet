{
  ...
  getAllVariables()::
    local scenario_path = '/tmp/container_scenario.yaml';
    ...
    local runUuidFilters = [
      ...
      'scenarios.parameters.scenarios.namespace.keyword: $namespace',
      'tag.keyword: $tag',
    ...
    [
      ...
      self.queryVariable('namespace', 'namespace', '{"find": "terms", "field": "scenarios.parameters.scenarios.namespace.keyword", "query": "cloud_infrastructure.keyword: $platform AND cloud_type.keyword: $cloud_type AND ' + scenarioFilter + '"}', '${Datasource}', true, true),
