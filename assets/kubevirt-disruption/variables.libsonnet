{
  ...
  getAllVariables()::
    ...
    [
      ...
      self.queryVariable('node_count', 'node_count', '{"find": "terms", "field": "node_summary_infos.count", "query": "cloud_infrastructure.keyword: $platform AND cloud_type.keyword: $cloud_type AND ' + scenarioFilter + '"}', '${Datasource}'),
      self.queryVariable('major_version', 'major_version', '{"find": "terms", "field": "major_version.keyword", "query": "cloud_infrastructure.keyword: $platform AND cloud_type.keyword: $cloud_type AND network_plugins.keyword: $networkType AND ' + scenarioFilter + '"}', '${Datasource}', true, true),
