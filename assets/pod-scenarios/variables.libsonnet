{
  ...
  getAllVariables()::
    local scenario_path = '/tmp/pod_scenario.yaml';
    ...
    local runUuidFilters = [
      ...
      'scenarios.parameters.config.namespace_pattern.keyword: $namespace',
      'tag.keyword: $tag',
    ...
    [
      ...
      self.queryVariable('namespace', 'namespace', '{"find": "terms", "field": "scenarios.parameters.config.namespace_pattern.keyword", "query": "cloud_infrastructure.keyword: $platform AND cloud_type.keyword: $cloud_type AND ' + scenarioFilter + '"}', '${Datasource}', true, true),
