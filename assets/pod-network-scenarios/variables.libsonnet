{
  ...
  getAllVariables():: [
    ...
    self.queryVariable('namespace', 'namespace', '{"find": "terms", "field": "scenarios.parameters.namespace.keyword", "query": "cloud_infrastructure.keyword: $platform AND cloud_type.keyword: $cloud_type AND scenarios.scenario_type.keyword: pod_network_scenarios"}', '${Datasource}', true, true),
    self.queryVariable('node_count', 'node_count', '{"find": "terms", "field": "node_summary_infos.count", "query": "cloud_infrastructure.keyword: $platform AND scenarios.scenario_type.keyword: pod_network_scenarios AND cloud_type.keyword: $cloud_type"}', '${Datasource}'),
    self.queryVariable('major_version', 'major_version', '{"find": "terms", "field": "major_version.keyword", "query": "cloud_infrastructure.keyword: $platform AND network_plugins.keyword: $networkType AND scenarios.scenario_type.keyword: pod_network_scenarios AND cloud_type.keyword: $cloud_type"}', '${Datasource}', true, true),
