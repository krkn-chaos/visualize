{
  ...
  getAllVariables()::
    local scenario_type = 'pod_network_scenarios';
    ...
    [
      ...
      self.queryVariable('namespace', 'namespace', '{"find": "terms", "field": "scenarios.parameters.namespace.keyword", "query": "cloud_infrastructure.keyword: $platform AND cloud_type.keyword: $cloud_type AND scenarios.scenario_type.keyword: ' + scenario_type + '"}', '${Datasource}', true, true),
